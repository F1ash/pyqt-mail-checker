...
class AppletSettings(QWidget):
	def __init__(self, obj = None, parent= None):
		...
		self.timeOutGroupBox = QSpinBox(self)
		self.timeOutGroupBox.setMinimum(1)
		self.timeOutGroupBox.setMaximum(200)
		self.timeOutGroupBox.setSingleStep(1)
		self.timeOutGroupBox.setValue(int(timeOutGroup))
